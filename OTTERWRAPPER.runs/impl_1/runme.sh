...
HD_PWD='C:/Users/austi/CPE/CPE 233/OTTERWRAPPER.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OTTERMCU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OTTERMCU.tcl -notrace
