...
HD_PWD='C:/Users/austi/CPE 233/Branch_addr_gen/Branch_addr_gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRANCH_ADDR_GEN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRANCH_ADDR_GEN.tcl
