...
HD_PWD='C:/Users/austi/CPE/CPE 233/OTTERWRAPPER.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OTTERMCU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OTTERMCU.tcl
