...
HD_PWD='C:/Users/austi/CPE 233/HW2_PC_MUX/HW2_PC_MUX.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_pc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_pc.tcl -notrace
