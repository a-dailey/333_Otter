...
HD_PWD='C:/Users/austi/CPE 233/HW2_PC_MUX/HW2_PC_MUX.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_pc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_pc.tcl
