...
HD_PWD='C:/Users/austi/CPE 233/Branch_cond_gen/Branch_cond_gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRANCH_COND_GEN.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRANCH_COND_GEN.tcl
